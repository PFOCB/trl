...
class ScriptArguments:
    ...
    checkpoint: Optional[str] = field(default=None, metadata={"help": "The path to a checkpoint to resume training"})
...
if script_args.checkpoint is not None:
    trainer.train(resume_from_checkpoint=script_args.checkpoint)
else:
    trainer.train()
